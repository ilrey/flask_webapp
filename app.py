...
def confronto():
    if g.utente:
        ...
        proccesso1 = multiprocessing.Process(target=moduli.grafico_a_barre, args=(session.get('costo_totale_attuale_f1', None)
                                                                                  ...
                                                                                  , g.utente))
        proccesso2 = multiprocessing.Process(target=moduli.grafico_a_torta, args=(session.get('costo_totale_attuale', None)
